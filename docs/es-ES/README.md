...
`piperread-gui` es un paquete separado que depende de `piperread`: instale primero el núcleo (o ambos en un mismo comando, por ejemplo `sudo apt install ./piperread_0.3.2~alpha_all.deb ./piperread-gui_0.3.2~alpha_all.deb`).
